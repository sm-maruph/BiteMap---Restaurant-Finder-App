...
<body>
                ...
                <tr>
                    <td>
                        <div class='row'>
                            ...
                            <div class='content'>
                                <div class="text">
                                    <p style="font-family:'Times New Roman', Times, serif; font-size: large;"><?php echo $row['post_content']; ?></p>
                                </div>
                                <div class="image">
                                    <div class="img1">
                                        <img src='<?php echo $row['post_image']; ?>'alt = "food">
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <form action="submit_post_user.php" method="post" enctype="multipart/form-data">
