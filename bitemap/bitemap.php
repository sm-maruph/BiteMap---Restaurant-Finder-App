        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
           ...
           echo '</p>';            
            ...
            //$_SESSION['map'] = $row['map'];
            ?>
            <a href="http://localhost/project/reservation.php?restaurant_name=<?php echo $row['restaurant_name']; ?>&policeStation=<?php echo $row['policeStaion']; ?>&contact_number=<?php echo $row['contactNumber1']; ?>&details_address=<?php echo $row['detailsAddress']; ?>" class="card-item">
          ...
          echo "Total Restaurant Found by your filter " . $count;
        } else {
